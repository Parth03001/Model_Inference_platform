...
def yolo_detection(model_path, cam_name, cam_url, low_threshold_ratio, high_threshold_ratio):
    """
    ...
    Args:
        ...
        height_threshold_ratio: Percentage of frame height for upper detection limit.
    """
    ...
    # Set individual thresholds per camera
    ...
    while True:
        ...
        if results[0].boxes.is_track:
            ...
            for box, track_id, cls_id in zip(boxes, track_ids, cls_ids):
                x, y, w, h = box
                if high_threshold < y < low_threshold:  # Ensure detection happens within thresholds
...
def start_detection():
    ...
    # model_path = r'weights\\best.engine'
    cameras = [
        # {
        #     "camera": "CCTV NO. 118 MHAWK STORE 2",
        #     "cam_url": "rtsp://admin:mahindra%40123@10.5.12.161/streaming/channels/101",
        #     "high_threshold": 0.20,  # 20% of frame height
        #     "low_threshold": 0.60  # 60% of frame height
        # },
        {
            "camera": "CCTV NO. 118 MHAWK STORE 2",
            "cam_url": "rtsp://admin:mahindra%40123@10.5.12.161/streaming/channels/101",
            "high_threshold": 0.30,  # 20% of frame height
            "low_threshold": 0.80  # 60% of frame height
        },
        {
        ...
        },
        {
            ...
            "high_threshold": 0.50,  # 20% of frame height
            "low_threshold": 0.90  # 60% of frame height
        },
        {
    ...
    for cam in cameras:
        process = multiprocessing.Process(
            ...
            args=(model_path, cam['camera'], cam['cam_url'], cam['low_threshold'], cam['high_threshold']), 
            daemon=True
        )
